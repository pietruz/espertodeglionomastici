 ...
 */
@WebServlet(urlPatterns = "/onomastici/*",  loadOnStartup = 1)
public class ActionsServlet extends HttpServlet {
  private static final Logger LOG = LoggerFactory.getLogger(EspertodegliOnomasticiApp.class);
  private final App actionsApp = new EspertodegliOnomasticiApp();
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    response
        .getWriter()
        .println(
            "it.trmn.espertodeglionomastici.ActionsServlet is listening but requires valid POST request to respond with Action response.");
  }
